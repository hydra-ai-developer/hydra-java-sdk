...
import ai.hydra.client.auth.Authentication;
import ai.hydra.client.auth.HttpBasicAuth;
import ai.hydra.client.auth.HttpBearerAuth;
import ai.hydra.client.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.hydra.ai/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("apiAuth", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.hydra.ai/v1
